...
{
    public class ClubODIModel
    {
        [Required]
        [Display(Name = "Id")]
        public int club_ODI_id { get; set; }

        [Display(Name = "ODI Batting Rank")]
        public int ODI_bat_rank { get; set; }
        ...
        public int ODI_bow_rank { get; set; }
        ...
        [Display(Name = "Club Team id")]
        public int team_id { get; set; }
        public List<ClubTeamsModel> Teams { get; set; }
    }
}
